...
Source: "setup\staging\back-end\*"; DestDir: "{app}\back-end"; Flags: recursesubdirs createallsubdirs skipifsourcedoesntexist
Source: "setup\staging\front-end\*"; DestDir: "{app}\front-end"; Flags: recursesubdirs createallsubdirs skipifsourcedoesntexist
Source: "setup\staging\base-ts-baileys-memory\*"; DestDir: "{app}\base-ts-baileys-memory"; Flags: recursesubdirs createallsubdirs skipifsourcedoesntexist
Source: "setup\staging\wearable\*"; DestDir: "{app}\wearable"; Flags: recursesubdirs createallsubdirs skipifsourcedoesntexist
Source: "setup\staging\installer\*"; DestDir: "{app}\installer"; Flags: recursesubdirs createallsubdirs skipifsourcedoesntexist
...
Name: "{group}\MC_NAILS_STUDIO"; Filename: "{app}\back-end\public\spa\index.html"
...
Filename: "powershell.exe"; Parameters: "-ExecutionPolicy Bypass -NoProfile -File ""{app}\installer\scripts\instalar.ps1"""; Flags: postinstall
